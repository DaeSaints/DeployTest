  ...
  return (
    <section className="h-[calc(100vh-80px)] bg-white flex flex-col items-center pt-10 justify-between relative">
      <Header
        heading={"UMONICS"}
        subheading={
          "Discover a unique approach to early childhood education that nurtures growth and development."
        }
      />
      ...
      <div className="absolute z-20 flex flex-col items-center justify-start gap-4 p-4 rounded-lg shadow-md shadow-main-400/20 translate-x-1/4 -bottom-24 left-1/4 w-72 bg-dark-2 h-96 -rotate-6">
      ...
      <div className="absolute z-10 flex flex-col items-center justify-start gap-4 p-4 translate-x-1/2 rounded-lg shadow-md shadow-main-400/20 -bottom-32 right-1/2 w-72 bg-dark-2 h-96">
        <div className="bg-main-400 w-full flex-[5] rounded-lg"></div>
        <div className="flex flex-col items-start justify-center flex-1 w-full text-left text-white">
      ...
      <div className="absolute z-0 flex flex-col items-center justify-start gap-4 p-4 rounded-lg shadow-md shadow-main-400/20 translate-x-1/4 -bottom-20 left-1/2 w-72 bg-dark-2 h-96 rotate-12">
        <div className="bg-main-400 w-full flex-[5] rounded-lg"></div>
        <div className="flex flex-col items-start justify-center flex-1 w-full text-left text-white">
