...
import { LucideStickyNote, PlusSquare } from "lucide-react";
      ...
      <article className="flex-1 w-full mt-4 overflow-hidden">
        <ScrollArea className="w-full h-[20rem] p-2">
          <ul className="flex flex-col w-full h-full gap-2">
            <li className="flex items-end justify-start gap-2 px-4 py-2 text-sm transition rounded-full hover:bg-slate-50 hover:text-black">
              <LucideStickyNote className="w-5" />
            ...
            <li className="flex items-end justify-start gap-2 px-4 py-2 text-sm transition rounded-full hover:bg-slate-50 hover:text-black">
              ...
              <span className="text-sm cursor-default">(Slides)</span>
            </li>
            <Modal
